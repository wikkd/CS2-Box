...
/**
 * Fired on the Forge event bus ({@link #BUS}) BEFORE a terminal purchase
 * consumes stock or Armory Points, and BEFORE the item is granted. Canceling
 * this event aborts the purchase cleanly — nothing is consumed, the terminal
 * stays in the player's hand and the negotiation session stays open.
 *
 ...
 * {@code ForgeEvents.onEvent('com.reclizer.csgobox.forge_1_20_1.event.TerminalBuyAttemptEvent', ...)}.
 ...
 */
public class TerminalBuyAttemptEvent extends PlayerEvent {
    ...
    public TerminalBuyAttemptEvent(Player player, ResourceLocation boxId, int grade,
