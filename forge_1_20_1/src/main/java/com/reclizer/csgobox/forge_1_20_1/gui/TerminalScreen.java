...
import com.reclizer.csgobox.forge_1_20_1.gui.terminal.TerminalActionBar;
import com.reclizer.csgobox.forge_1_20_1.gui.terminal.TerminalBottomRow;
import com.reclizer.csgobox.forge_1_20_1.gui.terminal.TerminalChatRegion;
...
public class TerminalScreen extends Screen {
    ...
    public void onTerminalState(PacketTerminalState state) {
        ...
        net.minecraft.resources.ResourceLocation boxId = ItemCsgoBox.getBoxId(terminalStack);
    ...
    public boolean mouseClicked(double mouseX, double mouseY, int button) {
        ...
        if (button == 1 && !this.inspectMenu.isOpen() && !confirmDialog.isOpen()) {
            ...
            if (offer != null && offerRegion.hitItem(this.mouseX, this.mouseY)) {
                ...
                if (!item.isEmpty()) {
                    ...
                    this.inspectMenu.openAt(this.mouseX, this.mouseY);
                    return true;
                }
            }
        }
        ...
        if (this.inspectMenu.isOpen()) {
            int action = this.inspectMenu.mouseClicked(button, this.mouseX, this.mouseY);
        ...
        if (confirmDialog.isOpen()) {
            TerminalConfirmDialog.Hit hit = confirmDialog.mouseDown(this.mouseX, this.mouseY, now);
    ...
    public boolean mouseReleased(double mouseX, double mouseY, int button) {
        ...
        long now = worldNowMs();
        TerminalActionBar.Fired fired = actionBar.mouseUp(this.mouseX, this.mouseY, now);
