...
public final class TerminalActionBar {
    ...
    private static final ResourceLocation TEX_INFO = new ResourceLocation("csgobox:textures/gui/terminal/terminal_info.png");
    private static final ResourceLocation TEX_CHEVRON = new ResourceLocation("csgobox:textures/gui/terminal/terminal_chevron.png");
