...
public class TerminalBootScreen extends Screen {
    ...
    public boolean mouseDragged(double mouseX, double mouseY, int button, double pDragX, double pDragY) {
        double pMouseX = mouseX;
        double pMouseY = mouseY;
        ...
        return super.mouseDragged(mouseX, mouseY, button, pDragX, pDragY);
    }
    ...
    public boolean mouseClicked(double mouseX, double mouseY, int button) {
        if (button == 0) {
            if (ButtonPalette.isInside(mouseX, mouseY, openButtonX(), buttonY(),
                    actionButtonWidth(), buttonHeight())) {
                Minecraft.getInstance().setScreen(new TerminalScreen(this.terminalStack));
                return true;
            }
            if (ButtonPalette.isInside(mouseX, mouseY, closeButtonX(), buttonY(),
                    actionButtonWidth(), buttonHeight())) {
                onClose();
                return true;
            }
