...
对批量开箱（总览屏 / 确认屏 / 流水揭晓屏）的一轮客户端 UI 打磨，六平台同步（v1_21_1 / v26_1_2 / v26_2 / forge_26_1_2 / forge_26_2 / forge_1_20_1）：
...
- **标题居中修正**：确认屏与结果屏头部标题均按缩放字号计算宽度后再居中（`titleScale` 1.4），消除长标题在缩放下的视觉偏移。
