...
public final class TerminalOfferRegion {
    ...
    public static final ResourceLocation TEX_AVATAR_WM = ResourceLocation.fromNamespaceAndPath("csgobox", "gui/terminal/terminal_avatar_wm");
    public static final ResourceLocation TEX_SCAN_BAND = ResourceLocation.fromNamespaceAndPath("csgobox", "gui/terminal/terminal_scan_band");
    ...
    private void drawWearBar(GuiGraphics gg, int x, int y, int w, int h) {
    ...
    private void drawArrow(GuiGraphics gg, int x, int y, float wearVal,
