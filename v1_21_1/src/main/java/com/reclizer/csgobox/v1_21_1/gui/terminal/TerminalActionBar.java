...
public final class TerminalActionBar {
    ...
    private static final ResourceLocation TEX_INFO = ResourceLocation.fromNamespaceAndPath("csgobox", "textures/gui/terminal/terminal_info.png");
    private static final ResourceLocation TEX_CHEVRON = ResourceLocation.fromNamespaceAndPath("csgobox", "textures/gui/terminal/terminal_chevron.png");
    ...
    private void drawCapsule(GuiGraphics gg, int x, int y, int w, int h,
    ...
    private void drawCapMenu(GuiGraphics gg, int x, int yTop, long nowMs,
    ...
    private void drawTooltip(GuiGraphics gg, int x, int y, Font font) {
