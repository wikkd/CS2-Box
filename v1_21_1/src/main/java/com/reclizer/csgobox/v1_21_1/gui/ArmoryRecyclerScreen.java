...
public class ArmoryRecyclerScreen extends AbstractContainerScreen<ArmoryRecyclerMenu> {
    ...
    private static final ResourceLocation TEXTURE =
            ResourceLocation.fromNamespaceAndPath(CsgoBox.MODID, "textures/gui/armory_recycler.png");
    ...
    protected void renderBg(GuiGraphics guiGraphics, float partialTicks, int mouseX, int mouseY) {
        AnimRenderOps.blitTextured(guiGraphics, TEXTURE, leftPos, topPos, imageWidth, imageHeight,
        ...
        if (progress > 0) {
            ...
            AnimRenderOps.blitTextured(guiGraphics, TEXTURE, leftPos + ARROW_X, topPos + ARROW_Y,
    ...
    protected void renderLabels(GuiGraphics guiGraphics, int mouseX, int mouseY) {
        ...
        RenderFontTool.drawString(guiGraphics, font, fcs(title.getString()), 8, 6, 0, 0, 1.0F, LABEL_COLOR);
        RenderFontTool.drawString(guiGraphics, font,
