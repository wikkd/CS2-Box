 ...
 * whenever a player successfully opens a box and receives a result item. This
 * is a <em>post-open notification</em> — the key and box have already been
 * consumed and the item has already been granted.
 *
 ...
 * {@code ForgeEvents.onEvent('com.reclizer.csgobox.forge_26_1_2.event.BoxOpenedEvent', ...)}.
 ...
 */
public class BoxOpenedEvent extends MutableEvent implements PlayerEvent {

    public static final EventBus<BoxOpenedEvent> BUS = EventBus.create(BoxOpenedEvent.class);
