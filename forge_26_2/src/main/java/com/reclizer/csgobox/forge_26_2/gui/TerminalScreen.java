...
import com.reclizer.csgobox.forge_26_2.gui.terminal.TerminalActionBar;
import com.reclizer.csgobox.forge_26_2.gui.terminal.TerminalBottomRow;
import com.reclizer.csgobox.forge_26_2.gui.terminal.TerminalChatRegion;
import com.reclizer.csgobox.forge_26_2.gui.terminal.TerminalConfirmDialog;
import com.reclizer.csgobox.forge_26_2.gui.terminal.TerminalOfferRegion;
import com.reclizer.csgobox.forge_26_2.gui.terminal.TerminalOfferItems;
import com.reclizer.csgobox.forge_26_2.item.ItemCsgoBox;
import com.reclizer.csgobox.forge_26_2.packet.Networking;
import com.reclizer.csgobox.forge_26_2.packet.PacketTerminalBuy;
import com.reclizer.csgobox.forge_26_2.packet.PacketTerminalBuyResult;
import com.reclizer.csgobox.forge_26_2.packet.PacketTerminalClose;
import com.reclizer.csgobox.forge_26_2.packet.PacketTerminalOpen;
import com.reclizer.csgobox.forge_26_2.packet.PacketTerminalReject;
import com.reclizer.csgobox.forge_26_2.packet.PacketTerminalState;
...
public class TerminalScreen extends Screen {
    ...
    public void extractRenderState(GuiGraphicsExtractor gg, int mouseX, int mouseY, float partialTicks) {
        ...
        // ---- trade-confirm dialog (modal overlay) ----
    ...
    public boolean mouseClicked(MouseButtonEvent event, boolean doubleClick) {
        ...
        if (event.button() == 1 && !this.inspectMenu.isOpen() && !confirmDialog.isOpen()) {
    ...
    public void init() {
        ...
        if (rearmOnShow) {
            ...
            Networking.sendToServer(new PacketTerminalOpen(terminalStack, requestId));
        }
    }
