...
> Auto-generated reference for the box JSON files in `config/csbox/`. The companion Simplified Chinese version is at [`_tutorial_v2.0.0beta-1_zh_cn.md`](./_tutorial_v2.0.0beta-1_zh_cn.md).
...
- Offers are priced in Armory Points. The price is the per-item `price`
  ...
  every 5% of wear adds 1 Armory Point on top of the item price.
