...
> 面向全部 **10 个平台模块**的 API 差异开发说明。按「版本分类 → 全量速查矩阵 → 主题展开」组织，帮助你在开发任何平台时快速定位「哪个 API、哪个版本、怎么写」。
...
|---|---|---|---|---|---|---|
| **legacy (旧 API)** | `v1_21_1` | 1.21.1 | 21.1.115 | 21 | 34 | ★ 基准 |
| | `v1_21_3` | 1.21.3 | 21.3.96 | 21 | 34 | |
| | `v1_21_4` | 1.21.4 | 21.4.157 | 21 | 34 | |
| | `v1_21_5` | 1.21.5 | 21.5.97 | 21 | 34 | |
| | `v1_21_8` | 1.21.8 | 21.8.53 | 21 | 34 | |
| | `v1_21_10` | 1.21.10 | 21.10.64 | 21 | 34 | |
| | `v1_21_11` | 1.21.11 | 21.11.42 | 21 | 34 | |
| **new (decoupled)** | `v26_1_2` | 26.1.2 | 26.1.2.76 | 25 + `--enable-preview` | 80 | ★ 基准 |
| | `v26_2` | 26.2 | 26.2.0.7-beta | 25 + `--enable-preview` | 81 (估算) | |
| **实验** | `forge_26_1_2` | 26.1.2 | Forge 64.1.0 | 25 | 80 | 非正式，勿当平台 |

> 关键结论：**legacy 内部 6 个断点**（1.21.3/.4/.5/.8/.10/.11）是 API 断点，**21.x→26.x** 是全面重构的 decoupled API，**26.1.2→26.2** 是小改。
