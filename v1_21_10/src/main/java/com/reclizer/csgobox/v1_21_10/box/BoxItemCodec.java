package com.reclizer.csgobox.v1_21_10.box;
...
final class BoxItemCodec {
    ...
    static ParseOutcome parseItem(JsonElement elem) {
        try {
            ...
            Item item = BuiltInRegistries.ITEM.get(ResourceLocation.parse(id)).map(net.minecraft.core.Holder.Reference::value).orElse(null);
            if (item == null) {
