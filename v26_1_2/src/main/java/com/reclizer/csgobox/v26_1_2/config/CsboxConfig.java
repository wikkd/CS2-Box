package com.reclizer.csgobox.v26_1_2.config;
...
public class CsboxConfig {
    ...
    // The GUI writes through ModConfigSpec so config/csgobox.toml remains the
    // single source of truth; call CsgoBox.CONFIG_SPEC.save() after setting.
