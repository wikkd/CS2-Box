...
public class ModSounds {
    ...
    public static Supplier<SoundEvent> CS_DITA = registerSoundEvent("cs_dita");
    public static Supplier<SoundEvent> CS_OPEN = registerSoundEvent("cs_open");
    public static Supplier<SoundEvent> CS_FINSH = registerSoundEvent("cs_finish");
}